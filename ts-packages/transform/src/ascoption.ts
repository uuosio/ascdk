...
import * as preprocess_1 from "./preprocess";
...
export class APIOptionImpl {
    checkAll: boolean = true;

    public readFile(filename, baseDir) {
    ...
    public writeExtensionFile(baseDir) {
        var sourceModifier = process.sourceModifier ? process.sourceModifier : new preprocess_1.SourceModifier();
    ...
    public writeGeneratedFile(outputDir) {
        var sourceModifier = process.sourceModifier ? process.sourceModifier : new preprocess_1.SourceModifier();
